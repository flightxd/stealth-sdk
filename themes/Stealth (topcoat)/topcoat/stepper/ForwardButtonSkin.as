...
package topcoat.stepper
{
	...
	dynamic public class ForwardButtonSkin extends MovieClipSkin
	{
		...
		public function ForwardButtonSkin()
		{
		...
		override protected function attachSkin():void
		{
			...
			if (contentGroup) {
				if (!contentGroup.layout) {
					...
					contentLayout.hAlign = Align.CENTER;
					contentLayout.vAlign = Align.MIDDLE;
