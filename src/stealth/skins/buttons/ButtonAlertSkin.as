...
package stealth.skins.buttons
{
	...
	public class ButtonAlertSkin extends Skin
	{
		Theme.registerSkin(ButtonAlertSkin);
		...
		public function ButtonAlertSkin()
		{
			bindTarget("focused");
		...
		override protected function create():void
		{
			...
			{ // 1 px dark border
				...
				border.fill = new LinearGradient([
					new GradientEntry(0x000000, .6),
					new GradientEntry(0x000000, .4),
				], -90);
			...
			{ // 1 px highlight across the top of the button
				...
				downState.change(highlight, {fill: new LinearGradient([
					...
					new GradientEntry(0x666666),
				], -90)});
				
				change = upSelectedState.change(highlight, {fill: new LinearGradient([
					new GradientEntry(0x446677),
					new GradientEntry(0xBBCCDD),
				], -90)});
