...
package flight.display
{
	...
	public class SimpleButton extends flash.display.SimpleButton implements IInvalidating, IMXMLObject
	{
		...
		public function set content(value:*):void
		{
			if (value is DisplayObject) {
				upState = overState = downState = hitTestState = DisplayObject(value);
			} else if (value is Array) {
				upState = DisplayObject(value[0]);
				overState = DisplayObject(value[1]) || upState;
				downState = DisplayObject(value[2]) || overState || upState;
				hitTestState = DisplayObject(value[3]) || downState || upState;
			}
		}
