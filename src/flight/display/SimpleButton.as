...
package flight.display
{
	...
	public class SimpleButton extends flash.display.SimpleButton implements ILifecycle, IMXMLObject
	{
		...
		public function set content(value:*):void
		{
			if (value is DisplayObject) {
				...
				downState = DisplayObject(value[2]) || overState;
				hitTestState = DisplayObject(value[3]) || upState;
			}
		}
